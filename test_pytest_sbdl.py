## Steps for automation of unit testing
# 1. Create a test file
# 2. Import the pytest package
# 3. Create a pytest fixture (used to do setting up the envirnment or required connections)
# 4. Create pytest functions
